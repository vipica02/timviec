...
class Scale extends MY_Controller
{	
	...
	*/
	...
	function index(){
		$input = array();
		$list = $this->scale_model->get_list($input);
		$this->data['list']=$list;
		$total = $this->scale_model->get_total();
		...
		if($this->input->post()){
			...
			if($this->form_validation->run()){
				...
				if($this->scale_model->create($data)){
		...
		$this->data['template'] ='admin/scale/index';
	...
	function edit(){
		...
		if($this->form_validation->run()){
				...
				if($this->scale_model->update($id,$data)){
