...
{	
	...
	*/
	...
	function index(){
		$input = array();
		$list = $this->experience_model->get_list($input);
		$this->data['list']=$list;
		...
		$this->data['template'] ='admin/experience/index';
	...
	function edit(){
		...
		$this->data['info']= $info;
		if($this->input->post()){
			$this->form_validation->set_rules('name','Kinh nghiệm','required');
