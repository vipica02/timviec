				...
				<div class="widget-box">
					...
					<div class="widget-body">
						<div class="widget-main">
							...
							<div>
								<label for="form-field-1" class="control-label bolder blue">Hình thức công việc<span class="red"><?php echo form_error('name'); ?></span></label>
								<div class="row">
									<div class="col-md-12 col-xs-12">
										<div class="input-group col-md-12 col-xs-12">
											<input type="text" id="name" name="name" placeholder="Hình thức công việc" value="<?php if(isset($info)){ echo $info->sFormWork;} else{echo '';} ?>" class="col-md-12 col-xs-12">
										</div>
									</div>
								</div>
							...
							<table id="dynamic-table" class="table table-striped table-bordered table-hover">
								...
								<?php if(!empty($list)){
									...
									<tr>
										...
										<td><?php echo $value->sFormWork; ?></td>
										...
										<td>
											<div class="hidden-sm hidden-xs action-buttons">
												...
												<a class="green" href="<?php echo admin_url('formwork/edit/'.$value->id); ?>" onclick="return confirmAction();">
													<i class="ace-icon fa fa-pencil bigger-130"></i>
												</a>

												<a class="red" href="<?php echo admin_url('formwork/delete/'.$value->id); ?>" onclick="return confirmAction();">
