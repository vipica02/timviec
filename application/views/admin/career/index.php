				...
				<div class="widget-box">
					...
					<div class="widget-body">
						<div class="widget-main">
							<div>
								<label for="form-field-1" class="control-label bolder blue">Ngành nghề<span class="red"><?php echo form_error('name'); ?></span></label>
								<div class="row">
									<div class="col-md-12 col-xs-12">
										<div class="input-group col-md-12 col-xs-12">
											<input type="text" id="name" name="name" placeholder="Ngành nghề" value="<?php if(isset($info)){ echo $info->sCareerName;} else{echo '';} ?>" class="col-md-12 col-xs-12">
										</div>
									</div>
								</div>
							...
							<div>
								<label for="form-field-1" class="control-label bolder blue">icon<span class="red"><?php echo form_error('icon'); ?></span></label>
								<div class="row">
									<div class="col-md-12 col-xs-12">
										<div class="input-group col-md-12 col-xs-12">
											<input type="text" id="icon" name="icon" placeholder="icon" value="<?php if(isset($info)){ echo $info->sIcon;} else{echo '';} ?>" class="col-md-12 col-xs-12">
										</div>
									</div>
								</div>
							...
							<div>
								<label for="form-field-1" class="control-label bolder blue">Mô tả<span class="red"><?php echo form_error('conten'); ?></span></label>
								<div class="row">
									<div class="col-md-12 col-xs-12">
										<div class="input-group col-md-12 col-xs-12">
										<textarea placeholder="Mô tả" class="col-md-12 col-xs-12" name="conten" id="conten"  rows="4"><?php if(isset($info)){ echo $info->sConten;} else{echo '';} ?></textarea>
										</div>
									</div>
								</div>
							...
							<table id="dynamic-table" class="table table-striped table-bordered table-hover">
								...
								<?php if(!empty($list)){
									...
									<tr>
										...
										<td><?php echo $value->sCareerName; ?></td>
										...
										<td>
											<div class="hidden-sm hidden-xs action-buttons">
												...
												<a class="green" href="<?php echo admin_url('career/edit/'.$value->id); ?>" onclick="return confirmAction();">
													<i class="ace-icon fa fa-pencil bigger-130"></i>
												</a>

												<a class="red" href="<?php echo admin_url('career/delete/'.$value->id); ?>" onclick="return confirmAction();">
