				...
				<div class="widget-box">
					...
					<div class="widget-body">
						<div class="widget-main">
							...
							<div>
								<label for="form-field-1" class="control-label bolder blue">Kinh nghiệm<span class="red"><?php echo form_error('name'); ?></span></label>
								<div class="row">
									<div class="col-md-12 col-xs-12">
										<div class="input-group col-md-12 col-xs-12">
											<input type="text" id="name" name="name" placeholder="Kinh nghiệm" value="<?php if(isset($info)){ echo $info->sExperience_name;} else{echo '';} ?>" class="col-md-12 col-xs-12">
										</div>
									</div>
								</div>
							...
							<table id="dynamic-table" class="table table-striped table-bordered table-hover">
								...
								<?php if(!empty($list)){
									...
									<tr>
										...
										<td><?php echo $value->sExperience_name; ?></td>
										...
										<td>
											<div class="hidden-sm hidden-xs action-buttons">
												...
												<a class="green" href="<?php echo admin_url('experience/edit/'.$value->id); ?>" onclick="return confirmAction();">
													<i class="ace-icon fa fa-pencil bigger-130"></i>
												</a>

												<a class="red" href="<?php echo admin_url('experience/delete/'.$value->id); ?>" onclick="return confirmAction();">
