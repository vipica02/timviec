...
<html lang="en">
	<head>
		...
		<!--[if lte IE 9]>
			<link rel="stylesheet" href="template/backend/assets/css/ace-part2.min.css" />
		<![endif]-->
		...
		<!--[if lte IE 8]>
		<script src="template/backend/assets/js/html5shiv.min.js"></script>
		<script src="template/backend/assets/js/respond.min.js"></script>
		<![endif]-->
	</head>
					...
					<div class="col-sm-10 col-sm-offset-1">
						<div class="login-container">
							<div class="center">
								...
								<h4 class="blue" id="id-company-text">&copy; Sang trần</h4>
							</div>
