						...
						<table id="dynamic-table" class="table table-striped table-bordered table-hover">
							...
							<form action="" method="post" enctype="multipart/form-data" class="form">
								<tr>
									...
									<td>
										<a href="#"><?php echo $value->sComName; ?></a>
									</td>
									...
									<td > <?php echo $value->dDate_Register; ?></td>									
									<td>
										<div class="hidden-sm hidden-xs action-buttons">
											<a class="green" onclick="return confirmedit();" href="<?php echo admin_url('notifications/edit/'.$value->id); ?>">
										...
										<div class="hidden-md hidden-lg">
											<div class="inline pos-rel">
												...
												<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
													...
													<li>
														<a href="<?php echo admin_url('notifications/edit/'.$value->id); ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
															<span class="green">
...
<SCRIPT LANGUAGE="JavaScript">
      function confirmedit(){
      	 return confirm("Bạn có chắc muốn thêm không?")
      }
