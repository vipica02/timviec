						...
						<div class="widget-main">
							...
							<div>
								...
								<label for="form-field-8 bolder " class="blue">Mô tả ngắn<span class="red"><?php echo form_error('conten'); ?></span></label>
									<textarea class="form-control" id="conten" rows="6" name="conten" placeholder="Mô tả ngắn"><?php echo set_value('conten');?></textarea>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="widget-main">
							...
							<div>
								...
								<div class="row">
									<div class="col-md-12 col-xs-12">
										<div class="input-group col-md-12 col-xs-12">
											<input type="text" id="link" name="link" placeholder="Link..." value="<?php echo set_value('link'); ?>" class="col-md-12 col-xs-12">
										</div>
									</div>
								</div>
