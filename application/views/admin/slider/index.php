					...
					<table id="simple-table" class="table  table-bordered table-hover">
						...
						<tbody>
							...
							<form action="" method="post" enctype="multipart/form-data">
								...
								<td>
									<?php echo $value->stitle; ?>
								</td>
								<td><?php echo $value->sContenName; ?></td>
								<td class="hidden-480"><?php echo $value->sLink; ?></td>
								<td class="hidden-480"><?php echo $value->sUpdate; ?></td>
								...
								<td>
									<div class="hidden-sm hidden-xs btn-group">
										...
										<a href="<?php echo admin_url('slider/delete/'.$value->id); ?>" onclick=" return confirmAction()" >
									...
									<div class="hidden-md hidden-lg">
										<div class="inline pos-rel">
											...
											<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
												...
												<li>
													<a href="<?php echo admin_url('slider/edit/'.$value->id); ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
														<span class="green">
												...
												<li>
													<a href="<?php echo admin_url('slider/delete/'.$value->id); ?>" class="tooltip-error" data-rel="tooltip" title="Delete">
														<span class="red">
															<i class="ace-icon fa fa-trash-o bigger-120"></i>
														</span>
													</a>
										...
										<div class="row">
											<div class="col-xs-12 col-sm-2">
												<div class="text-center">
													<img height="150" class="thumbnail inline no-margin-bottom" alt="Domain Owner's Avatar" src="<?php echo base_url('uploads/user/slider/'.$value->sImage);?>" />
													<br />
													<div class="width-80 label label-info label-xlg arrowed-in arrowed-in-right">
														<div class="inline position-relative">
															<a class="user-title-label" href="#">
																...
																&nbsp;
																<span class="white">Ảnh minh họa </span>
															</a>
														</div>
													</div>
												</div>
											...
											<div class="col-xs-12 col-sm-2">
												<div class="text-center">
													<img height="150" class="thumbnail inline no-margin-bottom" alt="Domain Owner's Avatar" src="<?php echo base_url('uploads/user/slider/'.$value->sBackgroud);?>" />
													<br />
													<div class="width-80 label label-info label-xlg arrowed-in arrowed-in-right">
														<div class="inline position-relative">
															<a class="user-title-label" href="#">
						...
						<thead>
							<tr>
								...
								<th class="detail-col">
								<a href="<?php echo admin_url('slider/add'); ?>">
