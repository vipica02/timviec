						...
						<table id="dynamic-table" class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
									...
									<th>Người tìm viêc</th>
									<th>Tiêu đề</th>
									<th class="hidden-480">Tiền lương</th>
							...
							<?php if(!empty($list)){?>
								<?php $i=0; foreach ($list as  $value) {$i++;?>
									...
									<td>
										<a href="<?php echo base_url('jop/hoso/'.$value->id); ?>"><?php echo  $value->sJobTitle; ?></a>
									</td>
								
									<td ><?php echo number_format($value->sWage).' VND'; ?></td>
									...
									<td>
										<div class="hidden-sm hidden-xs action-buttons text-center">
											<a class="green"   href="<?php echo nhatuyendung_url('user_jobseeker/submit/'.$value->id); ?>">
										...
										<div class="hidden-md hidden-lg">
											<div class="inline pos-rel">
												...
												<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
													...
													<li>
														<a  href="<?php echo nhatuyendung_url('user_jobseeker/submit/'.$value->id); ?>" class="tooltip-success" data-rel="tooltip" title="Tải hồ sơ">
															<span class="green">
