						...
						<table id="dynamic-table" class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
									...
									<th>Tiêu đề</th>
									<th class="hidden-480">Tỉnh/ thành</th>
							...
							<?php if(!empty($list)){?>
								<?php $i=0; foreach ($list as  $value) {$i++;?>
									...
									<td ><?php echo  $info_city[$i-1]->sCityName;?></td>
										...
										<div class="hidden-md hidden-lg">
											<div class="inline pos-rel">
												...
												<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
													...
													<li>
														<a  href="<?php echo nhatuyendung_url('search/download/'.$value->sFileName); ?>" class="tooltip-success" data-rel="tooltip" title="Nộp hồ sơ">
															<span class="green">
