						...
						<div class="widget-main">
								...
								<div class="row">
									<div class="col-md-12 col-xs-12">
										<div class="input-group col-md-12 col-xs-12">
											<input type="text" id="title" name="title" placeholder="Tiêu đề" value="<?php echo set_value('title'); ?>" class="col-md-12 col-xs-12">
										</div>
									</div>
								</div>
							...
							<div>
								...
								<div class="row">
									<div class="col-md-12 col-xs-12">
										<div class="input-group col-md-12 col-xs-12">
											<input type="text" id="number" name="number" placeholder="Số lượng" value="<?php echo set_value('number'); ?>" class="col-md-12 col-xs-12">
										</div>
									</div>
								</div>
							...
							<div>
								...
								<div class="radio">
									<label>
										<input name="gender" type="radio" value="2" class="ace">
								...
								<div class="row">
									<div class="col-md-12 col-xs-12">
										<div class="control-group">
											...
											<textarea class="form-control" id="JobContent" name="JobContent" rows="4" placeholder="Giới thiệu về bản thân"><?php echo set_value('JobContent'); ?></textarea>
										</div>
									</div>
								</div>
								<div class="space space-8"></div>
								...
								<div class="row">
									<div class="col-md-12 col-xs-12">
										<div class="control-group">
											...
											<textarea rows="4" class="form-control" id="sequireskill" name="requireskill" placeholder="yêu cầu công việc"><?php echo set_value('requireskill'); ?></textarea>
										</div>
									</div>
								</div>
								<div class="space space-8"></div>
					...
					<div class="widget-body">
						<div class="widget-main">
							<div>
								...
								<br />
								<select class="chosen-select form-control" id="form-field-select-3"  name="nature" data-placeholder="Choose a State...">
									<option value="<?php echo set_value('nature'); ?>"></option>
									<?php if($list){
							...
							<div>
								...
								<br />
								<select class="chosen-select form-control" id="form-field-select-3"  name="experience" data-placeholder="Choose a State...">
									<option value="<?php echo set_value('experience'); ?>"></option>
									<?php if($list2){
							...
							<div>
								...
								<br />
								<select class="chosen-select form-control" id="form-field-select-3"  name="wage" data-placeholder="Choose a State...">
									<option value="<?php echo set_value('wage'); ?>"></option>
									<?php if($list3){
					...
					<div class="widget-body">
						<div class="widget-main">
							<div>
								...
								<br />
								<select class="chosen-select form-control" id="form-field-select-3"  name="formwork" data-placeholder="Choose a State...">
									<option value="<?php echo set_value('formwork'); ?>"></option>
									<?php if($list4){
							...
							<div>
								...
								<br />
								<select class="chosen-select form-control" id="form-field-select-3"  name="probationary" data-placeholder="Choose a State...">
									<option value="<?php echo set_value('probationary'); ?>"></option>
									<?php if($list5){
							...
							<div>
								...
								<div class="row">
									<div class="col-md-12 col-xs-12">
										<div class="input-group col-md-12 col-xs-12">
											<input type="text" id="workplace" name="workplace" placeholder="Nơi làm việc: Hà nội,..." value="<?php echo set_value('workplace'); ?>" class="col-md-12 col-xs-12">
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-md-12 col-xs-12">
										<div class="control-group">
											...
											<textarea class="form-control" id="aboutright" name="aboutright" rows="4" placeholder="Giới thiệu về bản thân"><?php echo set_value('aboutright'); ?></textarea>
										</div>
									</div>
								</div>
								<div class="space space-8"></div>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="input-group">
											<input class="form-control date-picker" id="date_expiration" name="date_expiration" value="<?php echo set_value('date_expiration'); ?>" type="text" data-date-format="mm-dd-yyyy">
