						...
						<table id="dynamic-table" class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
									...
									<th class="hidden-480 ">Hồ sơ</th>
									<th class="hidden-480 ">Trạng thái</th>
									<th class="hidden-480 text-center">Tải hồ sơ</th>
								</tr>
							</thead>
							...
							<?php if(!empty($list)){?>
								<?php $i=0; foreach ($list as  $value) {$i++;?>
									...
									<td>
										<?php echo  $info_job[$i-1]->sJobTitle; ?>
									</td>
								
									<td ><?php echo  $info[$i-1]->sUserName;?></td>
									

									<td ><?php echo $info_jobseeker[$i-1]->sJobTitle; ?></td>
									<td><?php if($value->iStatus==0){echo 'Đã xem';}else{echo 'Chưa xem';} ?></td>
								
									<td>
										<div class="hidden-sm hidden-xs action-buttons text-center">
											<a class="green"  href="<?php echo nhatuyendung_url('notification/download/'.$info_jobseeker[$i-1]->sFileName); ?>" title="Tải hồ sơ">
										...
										<div class="hidden-md hidden-lg">
											<div class="inline pos-rel">
												...
												<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
													...
													<li>
														<a href="#" class="tooltip-success" data-rel="tooltip" title="Tải hồ sơ">
															<span class="green">
