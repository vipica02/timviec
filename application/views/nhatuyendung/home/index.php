				...
				<div class="row">
					...
					<div class="col-sm-7 infobox-container">
						<div class="infobox infobox-green">
							...
							<div class="infobox-data">
								<span class="infobox-data-number"><?php echo $employer_info->iHitView; ?></span>
								<div class="infobox-content">Lượt xem công ty</div>
							</div>
						</div>
						...
						<div class="infobox infobox-blue">
							...
							<div class="infobox-data">
								...
								<div class="infobox-content">Lượt xem tin</div>
							</div>
						...
						<div class="infobox infobox-pink">
							...
							<div class="infobox-data">
								...
								<div class="infobox-content">Hồ sơ đăng kí</div>
							</div>
					...
					<div class="col-sm-5">
						<h1 class="red">
							<?php 
							if($total_job==0){
								echo 'Bạn chưa có tin nào';
							}else{
							 echo 'Hiện tại bạn đang có: '; echo $total_job; echo' tin ';} 
							?>
							<a href="<?php echo nhatuyendung_url('trustworthy/add'); ?>" class="btn btn-primary">Đăng tin</a>
						</h1>
					</div><!-- /.col -->
				</div><!-- /.row -->
				<!-- PAGE CONTENT ENDS -->
						...
						<table id="dynamic-table" class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
									...
									<th>Ngày đăng</th>
									<th class="hidden-480">Hết hạn</th>
									<th class="hidden-480">Ứng tuyển</th>
									<th class="hidden-480">Đã xem</th>
									<th class="hidden-480">
								...
								<tr>
									...
									<td>
										<div class="hidden-sm hidden-xs action-buttons">
											...
											<a class="red" href="<?php echo nhatuyendung_url('trustworthy/delete/'. $value->id); ?> " onclick="return confirmAction();">
