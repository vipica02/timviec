						...
						<div class="widget-main">
								...
								<div class="row">
									<div class="col-md-12 col-xs-12">
										<div class="input-group col-md-12 col-xs-12">
											<input type="text" id="title" name="title" placeholder="Tiêu đề hồ sơ" value="<?php echo $info->sJobTitle; ?>" class="col-md-12 col-xs-12">
										</div>
									</div>
								</div>
							...
							<div>
								...
								<div class="row">
									<div class="col-md-12 col-xs-12">
										<div class="input-group col-md-12 col-xs-12">
											<input type="text" id="wage" name="wage" placeholder="Mức lương, chú ý các bạn lên viết bằng số" value="<?php echo $info->sWage; ?>" class="col-md-12 col-xs-12">
										</div>
									</div>
								</div>
							...
							<div>
								...
								<select class="chosen-select form-control" id="form-field-select-3"  name="diploma" data-placeholder="<?php if($info_diploma){echo $info_diploma->sDiplomaName;}else{echo 'Không tồn tại';}  ?>">
									<option value="<?php echo $info_diploma->id; ?>"></option>
									<?php if($list_diploma){
							...
							<div>
								...
								<br />
								<select class="chosen-select form-control" id="form-field-select-3"  name="exp" data-placeholder="<?php echo $info_exp->sExperience_name; ?>">
									<option value="<?php echo $info_exp->id; ?>"></option>
			...
			<div class="col-xs-12 col-sm-4">
					...
					<div class="widget-body">
						<div class="widget-main">
							...
							<div>
								...
								<br />
								<select class="chosen-select form-control" id="form-field-select-3"  name="ranks" data-placeholder="<?php echo $info_rank->sRankName; ?>">
									<option value="<?php echo $info_rank->id; ?>"></option>
									<?php if($list_rank){
							...
							<div>
								...
								<br />
								<select class="chosen-select form-control" id="form-field-select-3"  name="career" data-placeholder="<?php echo $info_career->sCareerName; ?>">
									<option value="<?php echo $info_career->id; ?>"></option>
									<?php if($list_career){
							...
							<div>
								...
								<br />
								<select class="chosen-select form-control" id="form-field-select-3"  name="city" data-placeholder="<?php echo $info_city->sCityName; ?>">
									<option value="<?php echo $info_city->id; ?>"></option>
									<?php if($list_city){
				...
				<div class="widget-box">
					...
					<div class="widget-body">
						<div class="widget-main">
							<div>
								<label for="form-field-select-3" class="control-label bolder blue">Hồ sơ<span class="red"><?php echo form_error('image'); ?></span></label>
