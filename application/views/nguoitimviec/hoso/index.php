						...
						<table id="dynamic-table" class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
									...
									<th class="hidden-480">Thuộc tính</th>
									<th class="hidden-480">
							...
							<?php if(!empty($list)){?>
								<?php foreach ($list as  $value) {?>
									...
									<td><?php if($value->sFileName!=''){ echo 'Hồ sơ đính kèm <i class="fa fa-file-code-o"></i>';}else{echo 'Hồ sơ trực tuyến';}  ?></td>
									<td><?php if($value->sUpdate==''){echo 'Chưa cập nhật';}else{ echo $value->sUpdate;} ?></td>
